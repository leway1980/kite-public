...
const educationResearchStories: Story[] = [
	...
	},
	{
		...
		talking_points: [
			'實施原則：2011 年 213 項校本 SEL 研究指出，符合 SAFE 原則的方案較穩。S 是有順序，A 是主動練習，F 是聚焦少數技能，E 是明確教出來。',
	...
	},
	{
		...
		talking_points: [
			...
			'核心發現：2012 年回顧的整體平均效果量約 .50，且教師引導條件比學生完全主導條件約高 .40；2016 年回顧顯示引導對學習活動、成功表現與學習結果都有正向效果。重點是引導，而不是放任探索。',
